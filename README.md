...
actively-changing project, and `main` can still have rough edges a single
verification pass won't catch. If you're bringing it into a new project,
budget time for it to need adjustment.
