- [Luna-Core repo](project_luna_core_repo.md) — starter kit at Documents\Claude\Luna-Core that every new project is bootstrapped from; git repo on dev, origin wired to GitHub, no commits yet
...
- [User's license tier](user_license_tier.md) — Claude Business Standard (teams); default to Sonnet unless asked otherwise
